...
parser.add_argument('--npl_depth', default=4, type=int, metavar='NPL Depth',
                    help='Which layer NPL is inserted')
...
def validate(args):
    ...
    """
    JS/3DTRL: only modification is here.
    """
    if "3dtrl_" in args.model:
        if "vit" in args.model:
            ...
            has_cls = False
            args.trl_depth = 1
        model = pkg.__dict__[args.model](
            global_pool=args.gp,
            trl_depth=args.trl_depth,
